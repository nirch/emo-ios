...
//  emu
//
//  Created by Aviv Wolf on 19/05/2016.
...
static UIColor* _colorThemeFeed = nil;
static UIColor* _colorThemeFeatured = nil;
static UIColor* _colorThemeMe = nil;
static UIColor* _colorThemeSettings = nil;
static UIColor* _colorThemeSearch = nil;
static UIColor* _colorThemeStore = nil;
static UIColor* _colorShareFBMBG = nil;
static UIColor* _colorShareTwitterBG = nil;
static UIColor* _colorShareFBBG = nil;
static UIColor* _colorShareAPMBG = nil;
static UIColor* _colorShareWhatsAppBG = nil;
static UIColor* _colorShareMailBG = nil;
static UIColor* _colorShareSaveBG = nil;
static UIColor* _colorShareCopyBG = nil;
static UIColor* _colorShareMiscBG = nil;
static UIColor* _colorShareInstagramBG = nil;
static UIColor* _colorThemeStore2 = nil;
...
+ (void)initialize
{
    ...
    _colorThemeFeed = [UIColor colorWithRed: 0.471 green: 0.788 blue: 0.122 alpha: 1];
    _colorThemeFeatured = [UIColor colorWithRed: 0.29 green: 0.565 blue: 0.886 alpha: 1];
    _colorThemeMe = [UIColor colorWithRed: 1 green: 0 blue: 0.392 alpha: 1];
    _colorThemeSettings = [UIColor colorWithRed: 0.961 green: 0.651 blue: 0.137 alpha: 1];
    _colorThemeSearch = [UIColor colorWithRed: 0.173 green: 0.702 blue: 0.294 alpha: 1];
    _colorThemeStore = [UIColor colorWithRed: 0 green: 0.333 blue: 0 alpha: 1];
    _colorShareFBMBG = [UIColor colorWithRed: 0.09 green: 0.529 blue: 0.984 alpha: 1];
    _colorShareTwitterBG = [UIColor colorWithRed: 0.349 green: 0.678 blue: 0.925 alpha: 1];
    _colorShareFBBG = [UIColor colorWithRed: 0.239 green: 0.361 blue: 0.6 alpha: 1];
    _colorShareAPMBG = [UIColor colorWithRed: 0.216 green: 0.627 blue: 0.039 alpha: 1];
    _colorShareWhatsAppBG = [UIColor colorWithRed: 0.114 green: 0.616 blue: 0.357 alpha: 1];
    _colorShareMailBG = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 1];
    _colorShareSaveBG = [UIColor colorWithRed: 0.452 green: 0.452 blue: 0.452 alpha: 1];
    _colorShareCopyBG = [UIColor colorWithRed: 0.319 green: 0.319 blue: 0.319 alpha: 1];
    _colorShareMiscBG = [UIColor colorWithRed: 0.384 green: 0.049 blue: 0.744 alpha: 1];
    _colorShareInstagramBG = [UIColor colorWithRed: 0.416 green: 0.271 blue: 0.235 alpha: 1];
    _colorThemeStore2 = [UIColor colorWithRed: 0.361 green: 0.602 blue: 0.096 alpha: 1];
...
+ (UIColor*)colorThemeFeed { return _colorThemeFeed; }
+ (UIColor*)colorThemeFeatured { return _colorThemeFeatured; }
+ (UIColor*)colorThemeMe { return _colorThemeMe; }
+ (UIColor*)colorThemeSettings { return _colorThemeSettings; }
+ (UIColor*)colorThemeSearch { return _colorThemeSearch; }
+ (UIColor*)colorThemeStore { return _colorThemeStore; }
+ (UIColor*)colorShareFBMBG { return _colorShareFBMBG; }
+ (UIColor*)colorShareTwitterBG { return _colorShareTwitterBG; }
+ (UIColor*)colorShareFBBG { return _colorShareFBBG; }
+ (UIColor*)colorShareAPMBG { return _colorShareAPMBG; }
+ (UIColor*)colorShareWhatsAppBG { return _colorShareWhatsAppBG; }
+ (UIColor*)colorShareMailBG { return _colorShareMailBG; }
+ (UIColor*)colorShareSaveBG { return _colorShareSaveBG; }
+ (UIColor*)colorShareCopyBG { return _colorShareCopyBG; }
+ (UIColor*)colorShareMiscBG { return _colorShareMiscBG; }
+ (UIColor*)colorShareInstagramBG { return _colorShareInstagramBG; }
+ (UIColor*)colorThemeStore2 { return _colorThemeStore2; }
...
+ (void)drawHalfCircleContainer
{
    ...
    //// HalfCircle Drawing
    CGRect halfCircleRect = CGRectMake(2, 2, 48, 24);
