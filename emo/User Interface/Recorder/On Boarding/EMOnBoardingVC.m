...
@property (weak, nonatomic) IBOutlet UIPageControl *guiStageIndicator;
...
-(NSInteger)updatePageIndicator
{
    ...
    self.guiStageIndicator.currentPage = currentPage;
    return currentPage;
}

-(void)updatePageIndicatorToIndex:(NSInteger)index
{
    self.guiStageIndicator.currentPage = index;
}
